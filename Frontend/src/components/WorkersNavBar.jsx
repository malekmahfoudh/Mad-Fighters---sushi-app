        ...
        <footer className="nav-container">
            <NavLink to="/new-orders">
                <section className={`new ${activeSection === "new" ? "active" : ""}`} style={{ position: 'relative' }}>
                    <img src={activeSection === "new" ? " ./public/icons/active-new.png" : " ./public/icons/new.png"} alt="" />
            ...
            <NavLink to="/preparing-orders">
                <section className={`prepare ${activeSection === "prepare" ? "active" : ""}`}>
                    <img src={activeSection === "prepare" ? " ./public/icons/active-prepare.png" : " ./public/icons/prepare.png"} alt="" />
                </section>
            </NavLink>
            <NavLink to="/ready-orders">
                <section className={`ready ${activeSection === "ready" ? "active" : ""}`}>
                    <img src={activeSection === "ready" ? " ./public/icons/active-ready.png" : " ./public/icons/ready.png"} alt="" />
                </section>
            </NavLink>
        </footer>
     );
